...
SECRET_KEY = ')d!9wv&)(c-e91@7@-2jm)_@rr&8fi!4$#8v-7mwlesr!ckf36'
...
TEMPLATE_DIR = os.path.join(BASE_DIR, "InfoApp/templates")
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, "InfoApp/static"),]
...
ACCOUNT_LOGIN_REDIRECT_URL = '/account/profile/'
